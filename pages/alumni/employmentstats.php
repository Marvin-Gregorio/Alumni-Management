...
<body style="background-color: #e0e0e0;">
    ...
    <div class="contianer-fluid" style="padding: 20px">
        <div class="row">
            ...
            <div class="text-end">
            <button onclick="updateEmploymentDetails()" class="btn btn-sm mt-2" style="background-color: #005bb1; color:#ffffff;font-weight:bold;">Update Employment Info</button>
            </div>
                    </div>
                </div>
            </div>
