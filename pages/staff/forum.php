                ...
                <div class="card">
                 <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="" id="blastBtn" class="btn btn-sm" style="background-color: #005bb1; color: #ffffff; font-weight: bold; font-size: .8rem;"  data-bs-toggle="modal" data-bs-target="#createevents"><i class="fas fa-circle-plus"></i> New Email Blast</a>
                    </div>
                    <hr>
