    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button id="updateeventclosemodal" type="button" class="btn-close btn-sm" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container" style="padding: 5px;">
                  ...
                  <div class="form-group">
                    <label for="" class="col-md-5 col-form-label">Events Description:</label>
                    <div class="col-md-12">
                        <textarea name="" id="update_event_description" class="form-control form-control-sm"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-md-5 col-form-label">Date:</label>
