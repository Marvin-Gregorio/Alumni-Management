<?php
	...
	$result = $search->designatedPost();
	
    if($result){

        for($count = 1; $count < sizeof($result); $count++){
            $counselor_name = $search->fullName($result[$count][5]);
            ...
            echo '                                              <div class="card mb-3" style="box-shadow: 0.5px 0.5px 2px rgba(0,0,0,0.25);border-bottom-right-radius: 20px;border-bottom-left-radius: 20px;">
                                                            <div class="card-body" style="padding-bottom: 0px;">
                                                                ...
                                                                <div class="row" style="margin-right: -24px;margin-left: -20px;">
                                                                    ...
                                                                    <div class="col" style="text-align: right;padding-right: 16px;"><span style="font-family: Poppins, sans-serif;font-size: 14px;">Shared to '.$counselor_name.'<br></span></div>
                                                                </div>
                                                            </div>
                                                        </div>';
        }
